...
import axios_current from "./axiosInstance";

export const histogramsFetch = async (data) => {
  const response = await axios_current.post('objectsearch/histograms', data);
  return response;
};

export const publicationFetch = async (data) => {
  const response = await axios_current.post('objectsearch', data);
  return response;
};

export const documentsFetch = async (data) => {
  const response = await axios_current.post('documents', data);
  return response;
};
